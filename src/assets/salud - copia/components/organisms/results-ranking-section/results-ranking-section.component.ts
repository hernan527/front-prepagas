...
import { ResultsRankingRowComponent } from '../../molecules/ranking-row/results-ranking-row.component';
import { NgFor } from '@angular/common';
import { FormsModule } from '@angular/forms';

@Component({
	selector: 'app-results-ranking-section',
	templateUrl: './results-ranking-section.component.html',
	styleUrls: ['./results-ranking-section.component.scss'],
	standalone: true,
    imports: [NgFor, ResultsRankingRowComponent,FormsModule]
})
export class ResultsRankingSectionComponent implements OnInit {
